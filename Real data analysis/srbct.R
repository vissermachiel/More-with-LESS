...
sim.list <- foreach(k = 1:K) %dopar% {
  ...
  for (fold in 1:nfolds) {
    ...
    # C.init.svml1.std <- 1 # based on cv on whole dataset
    ...
    # C.init.svml1.less <- 0.5623413 # based on cv on whole dataset
...
save(sim.list, file = "srbct_simlist.RData")
...
write.csv(results.mydata, "srbct.results.csv", row.names = FALSE)
...
write.csv(results.reps.mydata, "srbct.results.reps.csv", row.names = FALSE)
...
send_telegram_photo(photo = "srbct_numbetas.png",
                    caption = "Boxplot of the model dimensionality for the srbct dataset", 
                    chat_id = "441084295",
                    bot_token = "880903665:AAE_f0i_bQRXBXJ4IR5TEuTt5C05vvaTJ5w")

send_telegram_photo(photo = "srbct_auc.png",
                    caption = "Boxplot of the AUC values for the srbct dataset", 
                    chat_id = "441084295",
                    bot_token = "880903665:AAE_f0i_bQRXBXJ4IR5TEuTt5C05vvaTJ5w")

send_telegram_message(text = "The srbct script is finished!",
                      chat_id = "441084295",
                      bot_token = "880903665:AAE_f0i_bQRXBXJ4IR5TEuTt5C05vvaTJ5w")
