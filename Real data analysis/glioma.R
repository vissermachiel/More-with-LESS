...
sim.list <- foreach(k = 1:K) %dopar% {
  ...
  for (fold in 1:nfolds) {
    ...
    ### LESS + no scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LESS + none"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LESS + std"))

    # 10 fold cross-validation for penalisation parameter C
    C.hyper.less.std <- 10^seq(-4, 1, length.out = 51)
    # C.init.less.std <- 0.05623413 # based on cv on whole dataset
    ...
    ### LESS + LESS scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LESS + less"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LESS + lessstd"))
    
    # 10 fold cross-validation for penalisation parameter C
    C.hyper.less.lessstd <- 10^seq(-4, 1, length.out = 51)
    # C.init.less.lessstd <- 0.005623413 # based on cv on whole dataset
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LESS + lessstd2"))
    ...
    ### SVML1 + no scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", SVM + none"))
    
    # 10 fold cross-validation for penalisation parameter C
    C.hyper.svml1.none <- 10^seq(-4, 1, length.out = 51)
    # C.init.svml1.none <-  0.1778279 # based on cv on whole dataset
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", SVM + std"))
    
    # 10 fold cross-validation for penalisation parameter C
    C.hyper.svml1.std <- 10^seq(-4, 1, length.out = 51)
    # C.init.svml1.std <- 0.03162278 # based on cv on whole dataset
    ...
    ### SVML1 + LESS scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", SVM + less"))
    
    # 10 fold cross-validation for penalisation parameter C
    C.hyper.svml1.less <- 10^seq(-4, 1, length.out = 51)
    # C.init.svml1.less <- 0.1778279 # based on cv on whole dataset
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", SVM + lessstd"))
    
    # 10 fold cross-validation for penalisation parameter C
    C.hyper.svml1.lessstd <- 10^seq(-4, 1, length.out = 51)
    # C.init.svml1.lessstd <- 0.01 # based on cv on whole dataset
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", SVM + lessstd2"))
    
    # 10 fold cross-validation for penalisation parameter C
    C.hyper.svml1.lessstd2 <- 10^seq(-4, 1, length.out = 51)
    # C.init.svml1.lessstd2 <- 0.03162278 # based on cv on whole dataset
    ...
    ### LRL1 + no scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LogReg + none"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LogReg + std"))
    ...
    ### LRL1 + LESS scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LogReg + less"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LogReg + lessstd"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LogReg + lessstd2"))
    ...
    ### LASSO + no scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LASSO + none"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LASSO + std"))
    ...
    ### LASSO + LESS scaling ###
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LASSO + less"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LASSO + lessstd"))
    ...
    # print(paste0("Repetition ", k, " / ", K, ", fold ", fold, " / ", nfolds, ", LASSO + lessstd2"))
...
save(sim.list, file = "glioma_simlist.RData")
...
write.csv(results.mydata, "glioma.results.csv", row.names = FALSE)
...
write.csv(results.reps.mydata, "glioma.results.reps.csv", row.names = FALSE)
...
send_telegram_photo(photo = "glioma_numbetas.png",
                    caption = "Boxplot of the model dimensionality for the glioma dataset", 
                    chat_id = "441084295",
                    bot_token = "880903665:AAE_f0i_bQRXBXJ4IR5TEuTt5C05vvaTJ5w")

send_telegram_photo(photo = "glioma_auc.png",
                    caption = "Boxplot of the AUC values for the glioma dataset", 
                    chat_id = "441084295",
                    bot_token = "880903665:AAE_f0i_bQRXBXJ4IR5TEuTt5C05vvaTJ5w")

send_telegram_message(text = "The glioma script is finished!",
                      chat_id = "441084295",
                      bot_token = "880903665:AAE_f0i_bQRXBXJ4IR5TEuTt5C05vvaTJ5w")
