...
# Load data
mydata <- read.table("Data/metas.txt", quote = "\"", comment.char = "")
dim(mydata) # 78, 4920
table(mydata[, ncol(mydata)]) # 34, 44

mydata[, ncol(mydata)] <- as.factor(mydata[, ncol(mydata)])
lab1 <- levels(mydata[, ncol(mydata)])[1] # "1"
lab2 <- levels(mydata[, ncol(mydata)])[2] # "2"
...
sim.list <- foreach(k = 1:K) %dopar% {
  ...
  for (fold in 1:nfolds) {
    ...
    for (n in 1:nsamples) {
      ...
      C.init.less.none <- 0.00724436 # based on cv on whole dataset
      ...
      C.init.less.std <- 0.05495409 # based on cv on whole dataset
      ...
      C.init.less.less <- 0.0006025596 # based on cv on whole dataset
      ...
      C.init.less.lessstd <- 0.03162278 # based on cv on whole dataset
      ...
      C.init.less.lessstd2 <- 0.01584893 # based on cv on whole dataset
      ...
      C.init.svml1.none <- 0.005011872 # based on cv on whole dataset
      ...
      C.init.svml1.std <- 0.03311311 # based on cv on whole dataset
      ...
      C.init.svml1.less <- 0.008317638 # based on cv on whole dataset
      ...
      C.init.svml1.lessstd <- 25.11886 # based on cv on whole dataset
      ...
      C.init.svml1.lessstd2 <- 0.07943282 # based on cv on whole dataset
...
save(sim.list, file = "metas_samplesize_simlist.RData")
...
write.csv(plots.mydata, "metas_samplesize_results.csv", row.names = FALSE)
...
ggsave("metas_samplesize_numbetas.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         # ggtitle("Number of selected variables for increasing sample size (metas data)") +
         xlab("Sample size") +
...
ggsave("other plots/metas_samplesize_numbetas_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of number of selected variables for increasing sample size (metas data)") +
         xlab("Sample size") +
...
ggsave("metas_samplesize_AUC.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Test AUC for increasing sample size (metas data)") +
         xlab("Sample size") +
         ylab("AUC") +
         guides(color = guide_legend(order = 1, keywidth = 2.5),
                linetype = guide_legend(order = 2, keywidth = 2.5)) +
...
ggsave("other plots/metas_samplesize_AUC_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of test AUC for increasing sample size (metas data)") +
         xlab("Sample size") +
...
ggsave("metas_samplesize_accuracy.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Test accuracy for increasing sample size (metas data)") +
         xlab("Sample size") +
         ylab("Accuracy (%)") +
         guides(color = guide_legend(order = 1, keywidth = 2.5),
                linetype = guide_legend(order = 2, keywidth = 2.5)) +
...
ggsave("other plots/metas_samplesize_accuracy_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of test accuracy for increasing sample size (metas data)") +
         xlab("Sample size") +
...
ggsave("metas_samplesize_generror.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Generalisation error for increasing sample size (metas data)") +
         xlab("Sample size") +
...
ggsave("other plots/metas_samplesize_generror_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of generalisation error for increasing sample size (metas data)") +
         xlab("Sample size") +
...
send_telegram_message(text = "The metas script with increasing sample size is finished!",
                      chat_id = "441084295",
