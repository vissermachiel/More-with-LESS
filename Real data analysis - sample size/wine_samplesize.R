...
# Load data
mydata <- readMat("Data/wine.mat")
mydata <- cbind(as.data.frame(mydata$a$data), y = factor(mydata$a$nlab))
dim(mydata) # 44, 2701
table(mydata[, ncol(mydata)]) # 6 Argentina, 12 Chile, 15 Australia, 11 South Africa (?)
...
table(mydata[, ncol(mydata)]) # 21, 23
...
sim.list <- foreach(k = 1:K) %dopar% {
  ...
  for (fold in 1:nfolds) {
    ...
    for (n in 1:nsamples) {
      ...
      C.init.less.std <- 2.884032 # based on cv on whole dataset
      ...
      C.init.less.less <- 1.202264 # based on cv on whole dataset
      ...
      C.init.less.lessstd <- 1.380384 # based on cv on whole dataset
      ...
      C.init.less.lessstd2 <- 0.1 # based on cv on whole dataset
      ...
      C.init.svml1.none <- 0.1819701 # based on cv on whole dataset
      ...
      C.init.svml1.std <- 1.659587 # based on cv on whole dataset
      ...
      C.init.svml1.less <- 0.2290868 # based on cv on whole dataset
      ...
      C.init.svml1.lessstd <- 0.7585776 # based on cv on whole dataset
      ...
      C.init.svml1.lessstd2 <- 0.6309573 # based on cv on whole dataset
...
save(sim.list, file = "wine_samplesize_simlist.RData")
...
write.csv(plots.mydata, "wine_samplesize_results.csv", row.names = FALSE)
...
ggsave("wine_samplesize_numbetas.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         # ggtitle("Number of selected variables for increasing sample size (wine data)") +
         xlab("Sample size") +
...
ggsave("other plots/wine_samplesize_numbetas_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of number of selected variables for increasing sample size (wine data)") +
         xlab("Sample size") +
...
ggsave("wine_samplesize_AUC.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Test AUC for increasing sample size (wine data)") +
         xlab("Sample size") +
         ylab("AUC") +
         guides(color = guide_legend(order = 1, keywidth = 2.5),
                linetype = guide_legend(order = 2, keywidth = 2.5)) +
...
ggsave("other plots/wine_samplesize_AUC_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of test AUC for increasing sample size (wine data)") +
         xlab("Sample size") +
...
ggsave("wine_samplesize_accuracy.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Test accuracy for increasing sample size (wine data)") +
         xlab("Sample size") +
         ylab("Accuracy (%)") +
         guides(color = guide_legend(order = 1, keywidth = 2.5),
                linetype = guide_legend(order = 2, keywidth = 2.5)) +
...
ggsave("other plots/wine_samplesize_accuracy_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of test accuracy for increasing sample size (wine data)") +
         xlab("Sample size") +
...
ggsave("wine_samplesize_generror.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Generalisation error for increasing sample size (wine data)") +
         xlab("Sample size") +
...
ggsave("other plots/wine_samplesize_generror_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of generalisation error for increasing sample size (wine data)") +
         xlab("Sample size") +
...
send_telegram_message(text = "The wine script with increasing sample size is finished!",
                      chat_id = "441084295",
