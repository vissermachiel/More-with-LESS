...
# Load data
mydata <- readMat("Data/lung.mat")
mydata <- cbind(as.data.frame(mydata$a$data), y = factor(mydata$a$nlab))
dim(mydata) # 203, 3313
table(mydata[, ncol(mydata)]) # 139, 17, 21, 20, 6

# Response variable contains 5 categories >>> 1 vs rest
mydata[, ncol(mydata)] <- ifelse(mydata[, ncol(mydata)] == 1, 0, 1)
table(mydata[, ncol(mydata)]) # 139, 64
...
sim.list <- foreach(k = 1:K) %dopar% {
  ...
  for (fold in 1:nfolds) {
    ...
    for (n in 1:nsamples) {
      ...
      C.init.less.std <- 0.1096478 # based on cv on whole dataset
      ...
      C.init.less.less <- 0.1737801 # based on cv on whole dataset
      ...
      C.init.less.lessstd <- 0.008709636 # based on cv on whole dataset
      ...
      C.init.less.lessstd2 <- 0.03981072 # based on cv on whole dataset
      ...
      C.init.svml1.none <- 4.570882 # based on cv on whole dataset
      ...
      C.init.svml1.std <- 0.06309573 # based on cv on whole dataset
      ...
      C.init.svml1.less <- 0.4786301 # based on cv on whole dataset
      ...
      C.init.svml1.lessstd <- 0.01995262 # based on cv on whole dataset
      ...
      C.init.svml1.lessstd2 <- 13.18257 # based on cv on whole dataset
...
save(sim.list, file = "lung_samplesize_simlist.RData")
...
write.csv(plots.mydata, "lung_samplesize_results.csv", row.names = FALSE)
...
ggsave("lung_samplesize_numbetas.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         # ggtitle("Number of selected variables for increasing sample size (lung data)") +
         xlab("Sample size") +
...
ggsave("other plots/lung_samplesize_numbetas_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of number of selected variables for increasing sample size (lung data)") +
         xlab("Sample size") +
...
ggsave("lung_samplesize_AUC.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Test AUC for increasing sample size (lung data)") +
         xlab("Sample size") +
         ylab("AUC") +
         guides(color = guide_legend(order = 1, keywidth = 2.5),
                linetype = guide_legend(order = 2, keywidth = 2.5)) +
...
ggsave("other plots/lung_samplesize_AUC_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of test AUC for increasing sample size (lung data)") +
         xlab("Sample size") +
...
ggsave("lung_samplesize_accuracy.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Test accuracy for increasing sample size (lung data)") +
         xlab("Sample size") +
         ylab("Accuracy (%)") +
         guides(color = guide_legend(order = 1, keywidth = 2.5),
                linetype = guide_legend(order = 2, keywidth = 2.5)) +
...
ggsave("other plots/lung_samplesize_accuracy_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of test accuracy for increasing sample size (lung data)") +
         xlab("Sample size") +
...
ggsave("lung_samplesize_generror.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Generalisation error for increasing sample size (lung data)") +
         xlab("Sample size") +
...
ggsave("other plots/lung_samplesize_generror_sd.png",
       ggplot(plots.mydata, aes(x = SampleSize)) +
         ...
         scale_linetype_manual(values = c("dotted", "solid", "dashed", "longdash", "twodash"),
                               labels = unname(TeX(c("$\\textit{x}$", "$\\textit{z}$", "$\\textit{\\mu_k}$", 
                                                     "$\\textit{\\mu_k \\sigma^2_k}$", 
                                                     "$\\textit{\\mu_k \\bar{\\sigma}^2}$")))) +
         # ggtitle("Standard deviation of generalisation error for increasing sample size (lung data)") +
         xlab("Sample size") +
...
send_telegram_message(text = "The lung script with increasing sample size is finished!",
                      chat_id = "441084295",
